...
$string['privacy:metadata:aidifficulty'] = 'A dificuldade da IA associada a este registro: fácil, normal ou difícil.';
$string['privacy:metadata:cardid'] = 'O ID da carta Guardião ou de Lore, dependendo de cardtype.';
$string['privacy:metadata:cardtype'] = 'Se a carta é um Guardião ou uma carta de Lore.';
$string['privacy:metadata:playercards_attempts'] = 'Armazena cada partida concluída por um estudante em uma atividade PlayerCards.';
$string['privacy:metadata:playercards_attempts:lpremaining'] = 'Os pontos de vida restantes quando a partida terminou.';
$string['privacy:metadata:playercards_attempts:result'] = 'Se a partida terminou em vitória ou derrota.';
$string['privacy:metadata:playercards_attempts:score'] = 'A contribuição desta tentativa de partida para a nota.';
$string['privacy:metadata:playercards_attempts:turnsplayed'] = 'O número total de turnos jogados na partida.';
$string['privacy:metadata:playercards_deck_cards'] = 'Armazena as cartas que compõem o baralho salvo de um estudante.';
$string['privacy:metadata:playercards_decks'] = 'Armazena cada baralho salvo por um estudante em uma atividade PlayerCards.';
$string['privacy:metadata:playercards_decks:active'] = 'Se este é o baralho atualmente selecionado pelo estudante.';
$string['privacy:metadata:playercards_decks:name'] = 'O nome do baralho.';
$string['privacy:metadata:playercards_decks:size'] = 'O número total de cartas no baralho.';
$string['privacy:metadata:playercards_lore'] = 'Armazena cada carta de Lore criada por um professor para uma atividade PlayerCards.';
$string['privacy:metadata:playercards_lore:content'] = 'O texto educacional ou a descrição do efeito da carta de Lore.';
$string['privacy:metadata:playercards_lore:createdby'] = 'O ID do professor que criou esta carta de Lore.';
$string['privacy:metadata:playercards_lore:name'] = 'O nome da carta de Lore.';
$string['privacy:metadata:playercards_lore:subtype'] = 'O subtipo da carta de Lore: informação, quiz ou armadilha.';
$string['privacy:metadata:playercards_ownership'] = 'Armazena as cartas que um estudante possui em uma atividade PlayerCards.';
$string['privacy:metadata:playercards_questions'] = 'Armazena cada item do banco de perguntas próprio do PlayerCards, adicionado por um professor.';
$string['privacy:metadata:playercards_questions:addedby'] = 'O ID do professor que adicionou este item ao banco de perguntas.';
$string['privacy:metadata:playercards_questions:answers'] = 'As opções de resposta e qual delas está correta, quando aplicável.';
