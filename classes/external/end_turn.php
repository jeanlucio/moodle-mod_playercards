...
/**
 * External function: end the human's turn and process the AI's turn.
 *
...
/**
 * Ends the human's turn, playing the AI's whole turn and opening the human's next one.
 */
class end_turn extends external_api {
    /**
    ...
    public static function execute(int $cmid, string $token): array {
        ...
        $state = match_service::end_turn($cmid, (int) $USER->id, $instance, $token);
